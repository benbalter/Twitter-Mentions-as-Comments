...
class Plugin_Boilerplate_Enqueue {
	...
	function __construct( $instance ) {
		...
		add_action( 'admin_enqueue_scripts', array( &self::$parent->enqueue, 'enqueue_admin_js' ), 50 );
		add_action( 'admin_enqueue_scripts', array( &$self::$parent->enqueue, 'enqueue_admin_css' ), 50 );
		add_action( 'wp_enqueue_scripts', array( &self::$parent->enqueue, 'enqueue_front_end_css' ), 50 );
		add_action( 'wp_enqueue_scripts', array( &self::$parent->enqueue, 'enqueue_front_end_js' ), 50 );
